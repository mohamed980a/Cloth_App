...
class EmailAndPasswordSignup extends StatefulWidget {
  ...
  @override
  State<EmailAndPasswordSignup> createState() => _EmailAndPasswordState();
}

class _EmailAndPasswordState extends State<EmailAndPasswordSignup> {
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        children: [
          Text('Name',style: TextStyles.font14Black,),
          verticalSpace(5),
          AppTextFormField(hintText: 'Name', prefixIcon: Icon(Icons.person), validator: (value ) {
