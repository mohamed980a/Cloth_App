...
class _LoginApi implements LoginApi {
  ...
  Future<List<NewProduct>> getProductsCategory(
    ...
    final queryParameters = <String, dynamic>{
      r'keyword': keyword,
      r'limit': limit,
      r'subcategories[in]': subcategoryId,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<NewProduct>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<NewProduct> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => NewProduct.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
